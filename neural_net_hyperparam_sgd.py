...
def run_nn(params, input_size, output_size):
    ...
    print("    Train err  |   Test err  |   Alpha   |   Learning Rate   |   Momentum")
    ...
    def print_perf(epoch, W, alpha, learning_rate, momentum):
        ...
        print("{0:15}|{1:15}|{2:15}|{3:15}|{4:15}|{5:15}".format(epoch, train_perf, test_perf, alpha, learning_rate, momentum))
        f_out.write("{0:15}|{1:15}|{2:15}|{3:15}|{4:15}|{5:15}\n".format(epoch, train_perf, test_perf, alpha, learning_rate, momentum))
        f_out.close()
    ...
    final_test_err = frac_err(W, alpha, train_images, train_labels)
...
if __name__ == '__main__':
    ...
    learning_rate = 1e-5
    momentum = 0.1
    optimize.minimize(run_nn, (N, learning_rate, momentum), jac=run_nn_grad, method='L-BFGS-B', \
