...
def run_nn(params, input_size, output_size):
    ...
    momentum = params[2]
    num_epochs = int(np.floor(params[3]))
    ...
    print("    Train err  |   Test err  |   Alpha   |   Loss   |   Learning Rate   |   Momentum")
    ...
    def print_perf(epoch, W, alpha, learning_rate, momentum):
        ...
        print("{0:15}|{1:15}|{2:15}|{3:15}|{4:15}|{5:15}|{6:15}".format(epoch, train_perf, test_perf, alpha, loss, learning_rate, momentum))
        f_out.write("{0:15}|{1:15}|{2:15}|{3:15}|{4:15}|{5:15}|{6:15}\n".format(epoch, train_perf, test_perf, alpha, loss, learning_rate, momentum))
        f_out.close()
...
if __name__ == '__main__':
    ...
    momentum = 0.1
    num_epochs = 100
    optimize.minimize(run_nn, (N, learning_rate, momentum, num_epochs), jac=run_nn_grad, method='L-BFGS-B', \
